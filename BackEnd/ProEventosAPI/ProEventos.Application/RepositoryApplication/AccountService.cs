...
namespace ProEventos.Application.RepositoryApplication
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResult> CheckUserPassowordAsync(UserUpdateDto userUpdateDto, string password)
        {
            try
            {
        ...
        public async Task<UserUpdateDto> GetUserByUserNameAsync(string userName)
        {
            ...
            {
                throw new Exception($"Erro ao tentar identificar usuário por username. Erro: {ex.Message}");
            }
        }
